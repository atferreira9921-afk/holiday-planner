    ...
    <div className="card p-5 space-y-4">
      ...
      {mode === "text" ? (
        <div className="space-y-2">
          ...
          >
            {scanning && <span className="w-3.5 h-3.5 border-2 border-white/40 border-t-white rounded-full animate-spin" />}
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            disabled={scanning}
            className="w-full border-2 border-dashed border-slate-200 rounded-xl py-8 text-slate-400 hover:border-indigo-300 hover:text-indigo-500 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {scanning && <span className="w-3.5 h-3.5 border-2 border-slate-300 border-t-indigo-500 rounded-full animate-spin" />}
